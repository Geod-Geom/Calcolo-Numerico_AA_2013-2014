...
/*
 * Soluzione di un sistema lineare con il metodo di Gauss-Seidel
 *
 * AX = B
 *
 * Input:
 ...
 * del sistema lineare con il metodo di Gauss-Seidel
 *
 * riferimento pagina 55 slide Sistemi Lineari Prof. Pitolli
 */
